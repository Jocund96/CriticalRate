...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Avertical.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Ahorizon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Aicon_scatter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("excel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("clear_table.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        exportAction = QtWidgets.QAction(QtGui.QIcon('excel.png'), '&Экспорт в Excel', self)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QtGui.QIcon('coning.png'))
